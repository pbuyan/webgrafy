...
export function ServiceCard({
  ...
  const content = (
    <article className={cn(
      "rounded-3xl border border-stroke bg-white p-6 shadow-[0_12px_30px_rgba(0,0,0,0.04)]",
      href && "transition-shadow hover:shadow-[0_16px_40px_rgba(0,0,0,0.08)] h-full grid content-between",
    )}>
      <div>
