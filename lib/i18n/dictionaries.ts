...
const en: SiteDictionary = {
  ...
  contactBlock: {
    ...
    form: {
      ...
      fileHelp: "PDF, PNG, JPEG or WebP — 4 MB max.",
      ...
      errors: {
        ...
        fileTooLarge: "That file is larger than the 4 MB limit.",
        fileType: "Accepted formats: PDF, PNG, JPEG and WebP.",
...
const fr: SiteDictionary = {
  ...
  contactBlock: {
    ...
    form: {
      ...
      file: "Joindre un fichier (optionnel)",
      fileHelp: "PDF, PNG, JPEG ou WebP — 4 Mo maximum.",
      ...
      errors: {
        ...
        fileTooLarge: "Ce fichier dépasse la limite de 4 Mo.",
        fileType: "Formats acceptés : PDF, PNG, JPEG et WebP.",
